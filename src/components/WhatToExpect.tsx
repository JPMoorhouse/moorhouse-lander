...
const WhatToExpect: React.FC<WhatToExpectProps> = ({ pretitle, heading, WhatToExpect }) => {
  return (
    <div className="lg:py-20 py-16 custom-container relative">
      <p className="text-helper text-center text-lg mb-4">{pretitle}</p>
      <h2 className="lg:text-6xl md:text-5xl text-4xl lg:w-2/3 lg:leading-[70px] mx-auto font-medium text-center lg:mb-32 mb-20  mt-3">
        {heading}
      </h2>
